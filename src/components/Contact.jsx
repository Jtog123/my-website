      ...
      <div className="container">
        ...
        >
          ...
          <motion.div className="contact__body" variants={fadeUp}>
            ...
            <motion.a
              href="mailto:timetobuild@jamestogher.com"
              className="contact__email"
              whileHover={{ x: 4 }}
              transition={{ duration: 0.2, ease: [0.22, 1, 0.36, 1] }}
            >
              timetobuild@jamestogher.com
            </motion.a>
          </motion.div>

          <motion.div className="contact__socials" variants={fadeUp}>
            {[
              { label: 'GitHub', href: 'https://github.com/Jtog123', icon: 'M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22' },
              { label: 'LinkedIn', href: 'https://www.linkedin.com/in/james-togher-454719190/', icon: 'M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z M2 9h4v12H2z M4 4a2 2 0 1 0 0-4 2 2 0 0 0 0 4z' },
            ].map(social => (
              <motion.a
                key={social.label}
                href={social.href}
